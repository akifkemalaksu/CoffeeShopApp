    ...
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> ApiResources =>
            ...
            new ApiResource("CoffeeAPI"){
                Scopes = new string[]{"CoffeeAPI.read" , "CoffeeAPI.write" },
        ...
        public static IEnumerable<Client> Clients =>
            ...
            new Client{
                ...
                AllowedScopes = { IdentityServerConstants.StandardScopes.OpenId, IdentityServerConstants.StandardScopes.Profile, "CoffeeAPI.read" },
                RequirePkce = true,
                RequireConsent = true,
